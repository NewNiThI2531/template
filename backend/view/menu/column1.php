...
<form class="fron_IN" action="" target="calldata" method="POST" enctype="multipart/form-data">
  <div class="card box-content">
    <div class="row">
      ...
      <div class="text-center mt-4 mb-4">SUB&nbsp;&nbsp;MENU&nbsp;&nbsp;BAR&nbsp;&nbsp;ROW 1</div>


      <?php foreach ($banner as $key => $value): ?>
        <?php if ($value["menu_type"] == '5'): ?>
      ...
      <?php foreach ($banner as $key => $value): ?>
        <?php if ($value["menu_type"] == '7'): ?>
          <div class="col-3 paddin1 pt-0">
            <label class='paddinfont'>หัวข้อ 3 [ไทย/อังกฤษ] </label>
          </div>
          <div class="col-4 paddin1 pt-0">
            <input type="text" class="form-control mb-2 labl01" id="" name="title10_TH" value="<?= $value['menu_text'] ?>">
            <input type="hidden" class="form-control" id="" name="aid10" value="<?= $value['menu_id'] ?>">
          </div>
          <div class="col-4 paddin1 pt-0">
            <input type="text" class="form-control labl01" id="" name="title101_EN" value="<?= $value['menu_textEN'] ?>">
          </div>
      ...
      <?php foreach ($banner as $key => $value): ?>
        <?php if ($value["menu_type"] == '36'): ?>
          <div class="col-3 paddin1 pt-0">
            <label class='paddinfont'>หัวข้อ 4 [ไทย/อังกฤษ] </label>
          </div>
          <div class="col-4 paddin1 pt-0">
            <input type="text" class="form-control mb-2 labl01" id="" name="title11_TH" value="<?= $value['menu_text'] ?>">
            <input type="hidden" class="form-control" id="" name="aid11" value="<?= $value['menu_id'] ?>">
          </div>
          <div class="col-4 paddin1 pt-0">
            <input type="text" class="form-control labl01" id="" name="title111_EN" value="<?= $value['menu_textEN'] ?>">
          </div>
      ...
      <?php foreach ($banner as $key => $value): ?>
        <?php if ($value["menu_type"] == '37'): ?>
          <div class="col-3 paddin1 pt-0">
            <label class='paddinfont'>หัวข้อ 5 [ไทย/อังกฤษ] </label>
          </div>
          <div class="col-4 paddin1 pt-0">
            <input type="text" class="form-control mb-2 labl01" id="" name="title12_TH" value="<?= $value['menu_text'] ?>">
            <input type="hidden" class="form-control" id="" name="aid12" value="<?= $value['menu_id'] ?>">
          </div>
          <div class="col-4 paddin1 pt-0">
            <input type="text" class="form-control labl01" id="" name="title122_EN" value="<?= $value['menu_textEN'] ?>">
          </div>
      ...
      <?php foreach ($banner as $key => $value): ?>
        <?php if ($value["menu_type"] == '38'): ?>
          <div class="col-3 paddin1 pt-0">
            <label class='paddinfont'>หัวข้อ 6 [ไทย/อังกฤษ] </label>
          </div>
          <div class="col-4 paddin1 pt-0">
            <input type="text" class="form-control mb-2 labl01" id="" name="title13_TH" value="<?= $value['menu_text'] ?>">
            <input type="hidden" class="form-control" id="" name="aid13" value="<?= $value['menu_id'] ?>">
          </div>
          <div class="col-4 paddin1 pt-0">
            <input type="text" class="form-control labl01" id="" name="title133_EN" value="<?= $value['menu_textEN'] ?>">
          </div>

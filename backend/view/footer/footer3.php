...
<form class="fron_IN" action="" target="calldata" method="POST" enctype="multipart/form-data">
    <div class="card box-content pb-4">
        <div class="row">
            ...
            <div class="text-center mt-4 mb-4">HEAD&nbsp;&nbsp;&nbsp;FOOTE 1&nbsp;&nbsp;&nbsp;ROW 2</div>


            <?php foreach ($banner as $key => $value): ?>
                <?php if ($value["footer_Type"] == '14'): ?>
            ...
            <div class="text-center mt-4 mb-4">SUB&nbsp;&nbsp;&nbsp;FOOTE 1&nbsp;&nbsp;&nbsp;ROW 2</div>


            <?php foreach ($banner as $key => $value): ?>
                <?php if ($value["footer_Type"] == '15'): ?>
                    <div class="col-3 paddin1 m-0 p-2">
                        <p class='paddinfont text-center m-0 pb-2 ps-0'>หัวข้อ 2 [ไทย/อังกฤษ]</p>
                    </div>
                    <div class="col-4 paddin1 m-0 p-2">
                        <input type="text" class="form-control mb-1 labl01" id="" name="title7_TH"
                            value="<?= $value['foot_text'] ?>">
                        <input type="hidden" class="form-control" id="" name="aid7" value="<?= $value['foot_id'] ?>">
                    </div>
                    <div class="col-4 paddin1 m-0 p-2">
                        <input type="text" class="form-control labl01" id="" name="title77_EN"
                            value="<?= $value['foot_textEN'] ?>">
                    </div>
            ...
            <?php foreach ($banner as $key => $value): ?>
                <?php if ($value["footer_Type"] == '16'): ?>
                    <div class="col-3 paddin1 m-0 p-2">
                        <p class='paddinfont text-center m-0 pb-2 ps-0'>หัวข้อ 3 [ไทย/อังกฤษ]</p>
                    </div>
                    <div class="col-4 paddin1 m-0 p-2">
                        <input type="text" class="form-control mb-1 labl01" id="" name="title8_TH"
                            value="<?= $value['foot_text'] ?>">
                        <input type="hidden" class="form-control" id="" name="aid8" value="<?= $value['foot_id'] ?>">
                    </div>
                    <div class="col-4 paddin1 m-0 p-2">
                        <input type="text" class="form-control labl01" id="" name="title88_EN"
                            value="<?= $value['foot_textEN'] ?>">
                    </div>
    ...
    <div class="card box-content pb-4">
        <div class="row">
            ...
            <div class="text-center mt-4 mb-4">HEAD&nbsp;&nbsp;&nbsp;FOOTE 2&nbsp;&nbsp;&nbsp;ROW 2</div>


            <?php foreach ($banner as $key => $value): ?>
                <?php if ($value["footer_Type"] == '17'): ?>
                    <div class="col-3 paddin1 m-0 p-2">
                        <p class='paddinfont text-center m-0 pb-2 ps-0'>หัวข้อ 4 [ไทย/อังกฤษ]</p>
                    </div>
                    <div class="col-4 paddin1 m-0 p-2">
                ...
                <form class="save-banner" action="" target="calldata" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input class="form-control" type="file" name="fileuplad" id="photo"
                        ...
                        <div class="col-12 text-center">
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <button type="button" class="btn btn-cancle" name="button"

function ajaxRequest(params) {
    var url = 'view/contacform/calldata.php'
  ...
  $('body').on('click', '.btn-pen1', function () {
    ...
    data.append('id', id);
    $.ajax({
      url: 'view/contacform/calldata.php',
      method : "POST",
      data   : data,
      dataType: "json",
      contentType: false,
  ...
  var validation = Array.prototype.filter.call(save_aticle1, function(form) {
    ...
    $('body').on('click', '.btn-delete', function () {
      ...
      $('body').on('click', '.btn-add', function () {
        ...
        var save_aticle = document.getElementsByClassName('save_article2');
        var validation = Array.prototype.filter.call(save_aticle, function(form) {
        form.addEventListener('submit', function(event) {
          if (form.checkValidity() === false) {
            event.preventDefault();
            ...
            var data = new FormData(this);
            data.append('method','save_article2');
            $.ajax({
              url: 'view/contacform/calldata.php',
              method : "POST",
              data   : data,

function ajaxRequest(params) {
  var url = 'view/project/calldata.php'
  ...
  $('body').on('click', '.btn-pen', function () {
      ...
      $.ajax({
        ...
        success : function(data){
          // console.log(data);
          if(data.res_code=='00'){
            $('#aid').val(data.res_data.pro_id);
            $('#title').val(data.res_data.pro_headtext);
            $('#content').val(data.res_data.pro_text);
            $('#title_en').val(data.res_data.pro_headtextEN);
            $('#content_en').val(data.res_data.pro_textEN);
            $('#modal-edit-article').modal('show')

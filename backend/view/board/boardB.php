...
<div class="box-content">
  <div class="row">
    ...
    <div class="col-2">
      <a href="https://estate1.arrakmit.com/backend/index.php?page=board-create">
                    ...
                    <div class="row spaceQQ pt-5">
                      ...
                      <div class="col-8 ">
                        <select class="form-select select-y dd btn dropdown-toggle  rounded-5  border-4" name="sl"
                          ...
                          <option value="1">Audit Commmitee</option>
                          <option value="2">Risk Management Committee</option>
                          <option value="3">Nomination and Remuneration Committee</option>
                          <option value="4">Executive Committee</option>
                          <option value="5">Corporate Governance and Sustainable Development</option>
                          <option value="6">Committee</option>
                          <option value="7">Management Team</option>

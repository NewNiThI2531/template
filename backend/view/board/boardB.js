function loadingShow() {
  ...
  function ajaxRequest(params) {
    var url = 'view/board/calldataB.php'
  ...
  $('body').on('click', '.btn-pen', function () {
      ...
      $.ajax({
        ...
        success : function(data){
          // console.log(data);
          if(data.res_code=='00'){
            $('#aid').val(data.res_data.BOARD_id );
            $('#title').val(data.res_data.BOARD_Headtext);
            $('#content').val(data.res_data.BOARD_Text);
            $('#title_en').val(data.res_data.BOARDHeadtext_EN);
            $('#content_en').val(data.res_data.BOARDtext_EN);
            $('#sl').val(data.res_data.BOARD_Type);
            $('#modal-edit-article').modal('show')

...
function ajaxRequest(params) {
    var url = 'view/commercial/calldata.php'
  ...
  $('body').on('click', '.btn-edit', function () {
    ...
    data.append('id', id);
    $.ajax({
      url: 'view/commercial/calldata.php',
      method : "POST",
      data   : data,
      dataType: "json",
      contentType: false,
      ...
      success : function(data){
        ...
        if(data.res_code=='00'){
          $('#aid').val(data.res_data.commer_id );
          $('#title').val(data.res_data.commer_headtext);
          $('#content').val(data.res_data.commer_text);
          $('#title_en').val(data.res_data.commer_headtextEN);
          $('#content_en').val(data.res_data.commer_textEN);

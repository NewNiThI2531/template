<?php
  ...
  $banner = [];
   $sql = "SELECT * FROM `Database_content` WHERE Content_Page = '4' and con_image !='' ";
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-3 card-detail">
                  <div class="img-card" style='background: url("<?='../../'.$value['con_image']?>")'>
                  </div>
                </div>
                  ...
                  <div class="row" style="width: 100%;">
                    ...
                    <div class="col-4 text-center">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" data-id="<?=$value['set_id ']?>" <?=($value['Content_Status'] == "1" ? "checked" : "")?>>
                      </div>
                    </div>
                    <div class="col-4 text-center">

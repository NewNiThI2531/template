...
<?php foreach ($banner as $key => $value): ?>
        <?php if ($value["ct_type"] == '12'): ?>
      <div class="col-2 paddin1">
        <label class='paddinfont'>หัวข้อไทย </label>
      </div>
      <div class="col-8 paddin1">
        <input type="text" class="labl01" id="" name="content2_TH" value="<?= $value['ct_text'] ?>">
        <input type="hidden" class="form-control" id="" name="aid3" value="<?= $value['ct_id'] ?>">
      </div>
      ...
      <div class="col-8 paddin1">
        <input type="text" class="labl01" id="" name="content2_EN" value="<?= $value['ct_textEN'] ?>">
      </div>

...
<?php foreach ($banner as $key => $value): ?>
      ...
      <div class="col-8 paddin1">
        <textarea type="text" class="labl01 form-control" id="" name="content2_TH" style="height: 160px"><?= $value['con_text'] ?></textarea>
      ...
      <div class="col-8 paddin1">
        <textarea type="text" class="labl01 form-control" id="" name="content2_EN" style="height: 160px"><?= $value['con_textEN'] ?></textarea>
      </div>

...
<div class="card box-content m-4">
  <div class="row">
...
<?php foreach ($banner as $key => $value): ?>
      ...
      <div class="col-8 paddin1">
        <input type="text" class="form-control mb-2 labl01" id="" name="title2_TH" value="<?= $value['conhead_text'] ?>">
        <input type="text" class="form-control labl01" id="" name="content_TH" value="<?= $value['con_text'] ?>">
      ...
      <div class="col-8 paddin1">
        <input type="text" class="form-control mb-2 labl01" id="" name="title2_EN" value="<?= $value['conhead_textEN'] ?>">
        <input type="text" class="form-control labl01" id="" name="content_EN" value="<?= $value['con_textEN'] ?>">
      </div>
...
<div class="col-12 text-center paddin3 mb-4">

...
if($_REQUEST['method'] == 'get_article'){
  ...
  $content_en = $conn->real_escape_string($_POST['content_en']);
  if ($id != '') {
     $sql = "UPDATE `Database_setting` SET `Set_Type` = '$blog_blType' , `set_text` = '$title', `set_content` = '$content' , `set_textEN` = '$title_en', `set_contentEN` = '$content_en' WHERE `set_id` = '$id'";

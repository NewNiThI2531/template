...
$banner = [];
$banner = [];
$sql = "SELECT * FROM `Database_content` Where Content_Page = '18'  ";
...
<div class=" card mt-4 mb-4 box-content">
  <div class="row">
  ...
  <?php foreach ($banner1 as $key => $value): ?>
        <?php if ($value["Set_Type"] == '1'): ?>
          ...
          <div class="col-6 pt-4 pb-4 card-detail">
                  <div class="img-card" style='background: url("<?='../../'.$value['set_image']?>")'> </div>             
                </div>
                <div class="col-2 card-detail">
                <button type="button" name="button" class="btn btn-pen" data-path="<?='../../'.$value['set_image']?>" data-id="<?=$value['set_id']?>"><i class="fas fa-pen penex"></i></button>   
                </div>
...
<div class=" card mt-4 mb-4 box-content">
 ...
 <div class="text-center collumnhead mt-4">Header -- COLUMN 1</div>
...
<?php foreach ($banner as $key => $value): ?>
      ...
      <div class="col-8 paddin1">
        <input type="text" class="form-control labl01" id="" name="title2_TH" value="<?= $value['conhead_text'] ?>">
        <input type="text" class="form-control mt-2 labl01" id="" name="content_TH" value="<?= $value['con_text'] ?>">
      ...
      <div class="col-8 paddin1">
        <input type="text" class="form-control labl01" id="" name="title2_EN" value="<?= $value['conhead_textEN'] ?>">
        <input type="text" class="form-control mt-2 labl01" id="" name="content_EN" value="<?= $value['con_textEN'] ?>">
      </div>
      ...
      <div class="text-center collumnhead">Header -- COLUMN 2</div>
...
<?php foreach ($banner as $key => $value): ?>
      ...
      <div class="col-8 paddin1">
        <input type="text" class="form-control labl01" id="" name="title4_TH" value="<?= $value['conhead_text'] ?>">
        <input type="text" class="form-control mt-2 labl01" id="" name="content41_TH" value="<?= $value['con_text'] ?>">
      ...
      <div class="col-8 paddin1">
        <input type="text" class="form-control labl01" id="" name="title4_EN" value="<?= $value['conhead_textEN'] ?>">
        <input type="text" class="form-control mt-2 labl01" id="" name="content41_EN" value="<?= $value['con_textEN'] ?>">
      </div>
...
<div class="col-12 text-center mb-4 paddin3">

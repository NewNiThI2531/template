...
<div class="card box-content">
 ...
 <div class="text-center mt-4">TOP COLUMN</div>

<?php foreach ($banner as $key => $value): ?>
        <?php if ($value["cor_type"] == '1'): ?>
      <div class="col-2 paddin1">
        <label class='paddinfont'>หัวข้อไทย </label>
      </div>
      <div class="col-8 paddin1">
        <input type="text" class="form-control labl01 mb-3" id="" name="title2_TH" value="<?= $value['corhead_text'] ?>">
        <textarea type="text" class="form-control labl01" id="" name="content_TH" style="height: 200px"><?= $value['cor_text'] ?></textarea>
        <input type="hidden" class="form-control" id="" name="aid2" value="<?= $value['cor_id'] ?>">
      </div>
      ...
      <div class="col-8 paddin1">
        <input type="text" class="form-control labl01 mb-3" id="" name="title2_EN" value="<?= $value['corhead_textEN'] ?>">
        <textarea type="text" class="form-control labl01" id="" name="content_EN" style="height: 200px"><?= $value['cor_textEN'] ?></textarea>
      </div>
...
<div class="col-12 text-center mb-3 paddin3">

...
<?php foreach ($banner as $key => $value): ?>
      ...
      <textarea  type="text" class="labl01 form-control form-control-lg" id="" name="content_TH"  style="height: 200px"><?= $value['con_text'] ?></textarea>
      ...
      <div class="col-8 paddin1 pt-0">
        <textarea  type="text" class="labl01 form-control form-control-lg" id="" name="content_EN"  style="height: 200px"><?= $value['con_text'] ?></textarea>
      </div>

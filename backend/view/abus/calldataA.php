...
if(isset($_POST['aid51'])){
  $title51 = htmlspecialchars($_POST['title51_TH'], ENT_QUOTES);
  $title52 = htmlspecialchars($_POST['title51_EN'], ENT_QUOTES);
  $aid53 = htmlspecialchars($_POST['aid51'], ENT_QUOTES);

  $sql2 = "UPDATE `Database_content` 

  SET `conhead_text`     = '$title51',
      `conhead_textEN`  = '$title52'  
  WHERE `con_id` = '$aid53'";
...
if(isset($_POST['aid52'])){
  $title511 = htmlspecialchars($_POST['title52_TH'], ENT_QUOTES);
  $title522 = htmlspecialchars($_POST['title52_EN'], ENT_QUOTES);
  $aid52 = htmlspecialchars($_POST['aid52'], ENT_QUOTES);

  $sql2 = "UPDATE `Database_content` 

  SET `conhead_text`     = '$title511',
      `conhead_textEN`  = '$title522'  
  WHERE `con_id` = '$aid52'";

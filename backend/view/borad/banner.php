<?php
  ...
  $banner = [];
   $sql = "SELECT * FROM `Database_BOARD` WHERE BOARD_Page = '6' and BOARD_image !=''";
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-3 card-detail">
                  <div class="img-card" style='background: url("<?='../../'.$value['BOARD_image']?>")'>
                  </div>
                </div>
                  ...
                  <div class="row" style="width: 100%;">
                    ...
                    <div class="col-4 text-center">
                      <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" data-id="<?=$value['BOARD_id ']?>" <?=($value['BOARD_Status'] == "0" ? "checked" : "")?>>
                      </div>
                    </div>
                    <div class="col-4 text-center">
                      <button type="button" name="button" class="btn btn-pen" data-path="<?='../../'.$value['BOARD_image']?>" data-id="<?=$value['BOARD_id']?>"><i class="fas fa-pen"></i></button>
                    </div>
                  </div>
                </div>
              </div>

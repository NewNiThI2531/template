...
function ajaxRequest(params) {
  var url = 'view/blog/calldata.php'
...
$('body').on('click', '.btn-pen', function () {
    ...
    $.ajax({
      ...
      success : function(data){
        // console.log(data);
        if(data.res_code=='00'){
          $('#aid').val(data.res_data.bg_id);
          $('#title').val(data.res_data.bg_text);
          $('#content').val(data.res_data.bg_content);
          $('#title_en').val(data.res_data.bgtext_EN);
          $('#content_en').val(data.res_data.bgcontent_EN);
          $('#sl').val(data.res_data.blog_blType);
          $('#modal-edit-article').modal('show')
